...
@Repository("firecctvinfoDAO")
public class FirecctvInfoDAO extends NsesAbstractDAO {
    ...
    public String insertData(CctvInfoVO vo) throws Exception {
        return (String)insert("firecctvInfo.insertData", vo);
    }
    ...
    public int updateData(CctvInfoVO vo) throws Exception {
        return update("firecctvInfo.updateData", vo);
    }
    ...
    public int deleteData(CctvInfoVO vo) throws Exception {
        return delete("firecctvInfo.deleteData", vo);
    }
    ...
    public CctvInfoVO selectData(CctvInfoVO vo) throws Exception {
        return (CctvInfoVO) select("firecctvInfo.selectData", vo);
    }
    ...
    public List<?> selectListData(BasePageVO pageVO) throws Exception {
        return list("firecctvInfo.selectListData", pageVO);
    }
	...
	public int selectListCount(BasePageVO pageVO) {
        return (Integer) select("firecctvInfo.selectListCount", pageVO);
    }

	public void insertExcelData(List<CctvInfoVO> lstData) {
		insert("firecctvInfo.insertExcelData", lstData);
	}

	public int selectCctvName(String cctv_name) {
		return  (Integer) select("firecctvInfo.selectCctvName", cctv_name);
	}
}
