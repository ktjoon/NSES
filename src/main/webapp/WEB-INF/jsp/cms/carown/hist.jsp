...
<c:set value="차주정보 히스토리" var="sHtmlTitle"></c:set>
...
<head>
	...
	function onCheckSearch() {
		...
		document.listForm.action = '/cms/carown/hist.do';
	...
	function fn_egov_link_page(pageNo){
		...
		document.listForm.action = "<c:url value='/cms/carown/hist.do'/>";
	   	document.listForm.submit();
	}
    </script>
</head>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-desktop"></i> 차주정보 히스토리
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div style="clear:both">
			...
			<c:choose>
				<c:when test="${pageVO.searchKeyword != null }">
					...
					<input class="form-control" style="display:inline-block;width:200px; margin-bottom:20px; float:left;" type="text" name="searchKeyword" value="<c:out value="${pageVO.searchKeyword}"></c:out>" maxlength="20"/>
				</c:when>
				<c:otherwise>
					<label for="searchKeyword"></label>
					<input class="form-control" style="display:inline-block;width:200px; margin-bottom:20px; float:left;" type="text" name="searchKeyword" value="" maxlength="20"/>
				</c:otherwise>
			</c:choose>
          ...
          <table class="table table-bordered table-hover  ">
			...
			<tr>
				...
				<td class="text-center"><c:out value="${result.acc_name}"></c:out></td>
