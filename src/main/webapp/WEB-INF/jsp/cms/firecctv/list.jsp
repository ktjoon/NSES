...
<c:set value="화재감시 CCTV 목록" var="sHtmlTitle"></c:set>
...
<head>
    ...
    function onClickTrans(flag, ukey) {
    	...
    	if (flag == 'L') {
    		f.action = '/cms/firecctv/list.do';
    	}
    	else if (flag == 'R') {
    		f.action = '/cms/firecctv/reg.do';
    	}
    	else if (flag == 'E') {
    		document.listForm.cctv_guid.value = ukey;
    	   	document.listForm.action = '/cms/firecctv/edit.do';
    	   	document.listForm.submit();
    	}
    	else if (flag == 'V') {
    		f.action = '/cms/firecctv/view.do?cctv_guid=' + ukey;
    	}
    	else if (flag == 'goList') {
	...
	function onCheckSearch() {
		...
		document.listForm.action = '/cms/firecctv/list.do';
		document.listForm.submit();
	}
	...
	function fn_egov_link_page(pageNo){
		...
		document.listForm.action = "<c:url value='/cms/firecctv/list.do'/>";
	   	document.listForm.submit();
	}
    </script>
</head>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-desktop"></i> 화재감시 CCTV 목록
                            </li>
                        </ol>
                    </div>
                </div>
