...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<c:set value="화재감시 CCTV 등록" var="sHtmlTitle"></c:set>
...
<head>
    ...
    function doCctvRegAction() {
    	...
    	net_ajax(url, params, function(data) {
			if (data.retCode == const_ret_ok) {
				...
				url = '/cms/firecctv/reg_action.do';
    ...
    function uploadExcel() {
		...
		if (jQuery("#excel").val().match(/\.(xlsx|xls)$/i)){ 
			var form = $("#pageVO");
			form.attr({action:"/cms/firecctv/excel_upload.do",method:"post"});
			form.submit(); 
		}else{
			alert("엑섹 파일을 올려주세요.");
			return;
...
<form:form commandName="pageVO" name="regForm" method="post" enctype="multipart/form-data">
    <div id="wrapper">
        ...
        <div style="text-align: center;">
        	<!-- <a class="btn btn-default" style="margin-right:10px;" id="excelOpen" onclick="openExcelPop();">Excel등록</a> -->
